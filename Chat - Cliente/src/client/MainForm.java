...
public class MainForm extends javax.swing.JFrame {
    ...
    public void initFrame(String username, String host, int port){
        ...
        this.host = host;
        this.port = port;
        setTitle("Logado como: " + username);
        /** Connect **/
        connect();
    }
    
    public void connect(){
        appendMessage(" Conectando...", "Status", Color.RED, Color.RED);
        try {
            socket = new Socket(host, port);
            dos = new DataOutputStream(socket.getOutputStream());
            /** Send our username **/
            dos.writeUTF("CMD_JOIN "+ username);
            appendMessage(" Conectado", "Status", Color.RED, Color.RED);
            appendMessage(" Mensagem liberada", "Status", Color.RED, Color.RED);
    ...
    */
    ...
    private void initComponents() {
        ...
        privateUser = new javax.swing.JTextField();
        ...
        txtpane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        privateUser.setForeground(new java.awt.Color(120, 14, 3));
        privateUser.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jButton2.setBackground(new java.awt.Color(168, 16, 22));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(privateUser, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            appendMessage("Problema com com servidor ou servidor offline", "Error", Color.RED, Color.RED);
        }
    ...
    private void sendFileMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFileMenuActionPerformed
        ...
        if(!attachmentOpen){
            ...
            if(s.prepare(username, host, port, this)){
                ...
                JOptionPane.showMessageDialog(this, "Problema com com FTP ou servidor offline", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(this, "Deseja fechar a aplicacao?");
        if(confirm == 0){
            try {
                socket.close();
            } catch (IOException e) {
    ...
    private void LogoutMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutMenuActionPerformed
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(null, "Sair da conta?");
        if(confirm == 0){
            try {
                socket.close();
                setVisible(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //privado       
        try {
            String content = username+" "+privateUser.getText()+" "+ jTextField1.getText();
    ...
    private javax.swing.JTextField privateUser;
