                    ...
                    case "CMD_SENDFILE":
                        String consignee = null;
                            try {
                                ...
                                main.setMyTitle("Baixando Arquivo....");
                                ...
                                /*  Monitor Progress   */
                                ProgressMonitorInputStream pmis = new ProgressMonitorInputStream(main, "Baixando Arquivo por favor espere...", input);
                                /*  Buffer   */
                                ...
                                fos.flush();
                                fos.close();
                                main.setMyTitle("Você esta logado como: " + main.getMyUsername());
                                JOptionPane.showMessageDialog(null, "Arquivo foi baixado para  \n'"+ path +"'");
                                System.out.println("Arquivo Salvado: "+ path);
                            } catch (IOException e) {
                                /*
                                ...
                                */
                                ...
                                eDos.writeUTF("CMD_SENDFILERESPONSE "+ consignee + " Conexão perdida, tente novamente depois.!");
