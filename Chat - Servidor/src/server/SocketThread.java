...
public class SocketThread implements Runnable{
    ...
    private void createConnection(String receiver, String sender, String filename){
        try {
            main.appendMessage("[createConnection]: Criando uma conexao de compartilhamento de arquivo");
            ...
            if(s != null){ // Client was exists
                ...
                main.appendMessage("[createConnection]: Cliente nao encontrado '"+receiver+"'");
                DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                dos.writeUTF("CMD_SENDFILEERROR "+ "Cliente '"+receiver+"' nao encontro na lista");
            }
        } catch (IOException e) {
    ...
    public void run() {
        try {
            while(true){
                ...
                switch(CMD){
                    case "CMD_JOIN":
                        ...
                        main.appendMessage("[Client]: "+ clientUsername +" entrou no chat ");
                        break;
                    ...
                    case "CMD_CHAT":
                        ...
                        try {
                            ...
                            /** CMD_MESSAGE **/
                            String content = from +" "+ msg; // Faz a montagem do conteudo da mensagem
                            dos.writeUTF("CMD_MESSAGE "+ content);  // Envia para o cliente 
                            main.appendMessage("[Message]: De "+ from +" para "+ sendTo +" : "+ msg);// Envia para o servidor
                        } catch (IOException e) { 
                            main.appendMessage("[IOException]: Impossivel enviar a mensagem privada "+ sendTo); 
                        }
                        break;
                    ...
                    case "CMD_CHATALL":
                        ...
                        String chatall_content = chatall_from+" "+ chatall_msg; // Faz a montagem do conteudo da mensagem
                        ...
                        main.appendMessage("[CMD_CHATALL]: "+ chatall_content); // Envia para o servidor
                        break;
                    
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage("CMD_SHARINGSOCKET : Cliente iniciou um compartilhamento de arquivo");
                        ...
                        main.appendMessage("CMD_SHARINGSOCKET : Nickname: "+ file_sharing_username);
                        main.appendMessage("CMD_SHARINGSOCKET : Compartilhamento iniciado");
                        break;
                    ...
                    case "CMD_SENDFILE":
                        ...
                        main.appendMessage("CMD_SENDFILE : Preparando conexao");
                        Socket cSock = main.getClientFileSharingSocket(sendto);
                        if(cSock != null){ 
                            try {
                                main.appendMessage("CMD_SENDFILE : Conectado..!");
                                /** First Write the filename..  **/
                                main.appendMessage("CMD_SENDFILE : Enviando arquivo...");
                    ...
                    case "CMD_SEND_FILE_XD":                          
                        try {
                            ...
                            main.appendMessage("[CMD_SEND_FILE_XD]: Host: "+ send_sender); //Imprime no servidor
            ...
            System.out.println("Arquivo compartilhado: " +filesharing_username);
            main.removeFromTheList(client);
            if(filesharing_username != null){
                main.removeClientFileSharing(filesharing_username);
            }
            main.appendMessage("[SocketThread]: Cliente perdeu conexao");
        }
    }
